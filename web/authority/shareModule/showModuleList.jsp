	...
	<body>
		...
		<display:table name="requestScope.list" id="item" >
			...
			<display:column title="操作">
				<a href="<%=basePath%>authority/shareModuleAction!getModuleById.action?module.moduleId=${item.moduleId}"><img
						src="<%=basePath%>images/edit.gif" border="0">編輯</a>
			</display:column>
			<display:column title="操作">
				<a
					href="<%=basePath%>authority/shareModuleAction!deleteModule.action?module.moduleId=${item.moduleId}"><img
						src="<%=basePath%>images/delete.gif" border="0">刪除</a>
			</display:column>
		</display:table>
		<a href="<%=basePath%>authority/shareModule/addModule.jsp">添加新的模块</a>
	</body>
</html>
